...
if __name__ == '__main__':
    ...
    #model.rnn1.weight_hh_l0.data.normal_(0,0.5)
    #model.rnn1.weight_ih_l0.data.normal_(0,0.5)
    ...
    for epoch in range(1, epochs + 1):
        ...
        #print(encode(y_pred.data.cpu().numpy())[0])
        #print(encode(y_batch.data.cpu().numpy())[0])
